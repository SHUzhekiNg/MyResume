...
{Jul 2024 -- Now}
  ...
  [Shanghai, China]
  \begin{itemize}
    \item Design and develop \textbf{Python} workflow tasks of self-operated closed-loop data platform.
    \item Deploy and finetune prompts of \textbf{multimodal LLMs} towards better and automatic data annotation and mining.
    \item Write \textbf{Python-Database} interfaces to add, delete, update and retrieve large amounts of data that stored in \textbf{PostgreSQL} and \textbf{AWS}.
    \item Speed up I/O of specific files(JPGs, PKLs, and PCDs) using \textbf{C++ and Pybind11} with an average of \textbf{50\%} faster.
  \end{itemize}
...
\begin{compactlist}
  ...
  \item \textbf{English}: Overall band 7 for IELTS Acadamic Test (L7.5, R8.5, W6, S6.5)
