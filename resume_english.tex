...
{Dec 2023 -- Now}
  ...
  [Shanghai, China]
  \begin{itemize}
    \item \textbf{Aim}: Optimize 3D reconstruction algorithm to auto-driving scene and produce better results.
  \end{itemize}
\section{Projects}
...
\cventry{Point-based Scene Warping for High-quality Neural Radiance Fields}
  ...
  \begin{itemize}
    ...
    \item \textbf{Content}: Migrated \href{https://github.com/Xharlie/pointnerf/}{\textbf{Point-NeRF}} to \href{https://github.com/nerfstudio-project/nerfstudio/}{\textbf{nerfstudio}}, Project Link: \href{https://github.com/nerfstudio-project/nerfstudio/}{\textbf{pointnerf2studio}}
  \end{itemize}
