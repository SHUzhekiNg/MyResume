...
{Dec 2023 -- Now}
  ...
  \begin{itemize}
    ...
    \item \textbf{Content}: Developed a frontend and backend platform using Vue+Flask. By reading evaluation metrics in real-time, the system can easily visualize the result online. Also, participated in the development of automated evaluations, and automatically conduct weekly algorithm metric evaluations throughout the entire process. 
  \end{itemize}
